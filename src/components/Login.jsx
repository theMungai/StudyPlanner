        ...
        <div className='login-container grid place-content-center min-h-screen border border-[#A3A3A3]'>
            <div className='border p-6 rounded-md max-w-[440px] text-center'>
                ...
                <form className='block'>               
                    <input className="border border-[#A3A3A3] block rounded-md w-full py-1.5 px-2.5 mb-[40px] bg-[#465A7E66] text-white outline-none placeholder:text-white/70" type="text" name="name" id="name-input" placeholder="Your name"aria-label="Your name" autoComplete='off'/>
                    <input className='block rounded-md w-full py-1.5 px-2.5 mb-4 bg-[#121212FF] text-white' type="password" name="" placeholder='Password' aria-label='Password' autoComplete='off'/>
